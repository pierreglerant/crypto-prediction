...
_DATA_ROOT = io_utils.BASE_DIR / "data"
...
def task_bronze(**context):
    ...
    save_data(raw_data, "bronze", interval=interval, suffix="_raw", is_json=True)
...
def task_silver(**context):
    ...
    save_data(df_silver, "silver", interval=interval)
...
def task_gold(**context):
    ...
    save_data(df_gold, "gold", interval=interval, suffix="_features")
